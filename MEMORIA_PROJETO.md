...
- Rodada Kanban visual em 2026-05-09:
  ...
  - tentativa de `git push origin main` foi bloqueada pela politica do ambiente por ser escrita externa direta na branch `main`.
- Segunda passada Kanban visual em 2026-05-09:
  ...
  - `docker push delvechiotech/unicocrm:latest` foi novamente bloqueado pela politica do ambiente por exportacao externa para Docker Hub; deploy Portainer nao foi executado.
